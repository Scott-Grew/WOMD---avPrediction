...
def train_epoch(predictor, optimizer, batches, device):
...
def main():
    ...
    for epoch_index in range(arguments.epochs):
        ...
        averages, monitor, seconds = train_epoch(predictor, optimizer, batches, device)
        print(
        ...
        torch.save(
            {"model_state": predictor.state_dict(), "optimizer_state": optimizer.state_dict()},
